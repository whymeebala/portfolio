! function(t, e, i, n) {
    ...
    function i(t, e, i) {
        $(".main-content").children().find('li').removeClass("section--is-active"), $(".main-content").children().eq(e).find('li').addClass("section--is-active"), $(".main-content .section").children().find('li').removeClass("section--next section--prev"), t === i && 0 === e || 0 === t && e === i ? $(".main-content .section").children().find('li').removeClass("section--next section--prev") : e > t ? $(".main-content").children().eq(t).children().find('li').addClass("section--next") : $(".main-content").children().eq(t).children().find('li').addClass("section--prev"), 0 !== e && e !== i ? $(".header--cta").addClass("is-active") : $(".header--cta").removeClass("is-active")
    }
